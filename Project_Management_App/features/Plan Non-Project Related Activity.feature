...
Scenario: Employee takes time off succesfully
	...
	Then the NonWorkActivity "Sickness" is set to 10.0 hours for Week "9002"
	And the Employee has a total of 40.0 hours Planned Work for Week "9002"	
...
Scenario: Employee takes time off unsuccesfully
	...
	Then the NonWorkActivity "Sickness" is set to 0.0 hours for Week "9002"
	And the error is thrown "WARNING: The total planned work exceeds 50 hours for the week. Please contact a Project Manager"
...
Scenario: Employee takes more time off for multiple weeks succesfully
	...
	Then the NonWorkActivity "Holiday" is set to 50.0 hours for Week "9002"
	And the NonWorkActivity "Holiday" is set to 50.0 hours for Week "9003"
...
Scenario: Employee takes more time off for multiple weeks unsuccesfully
	...
	And the NonWorkActivity "Holiday" is set to 50.0 hours for Week "9002"
	And the NonWorkActivity "Holiday" is set to 0.0 hours for Week "9003"
	And the Employee has a total of 50.0 hours Planned Work for Week "9002"
