...
public class ActivitySteps {
	...
	public ActivitySteps(App projectApp, ProjectHelper projectHelper, EmployeeHelper employeeHelper, ActivityHelper activityHelper, 
	...
	public void an_workactivity_with_name_is_assigned_to_the_project(String string) {
	   projectApp.createWorkActivity(string, 0, 0);
	}
